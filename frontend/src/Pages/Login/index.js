                    ...
                    <div className="w-4/5 p-5 text-sm text-center text-white rounded-lg shadow-inner shadow-red-500 md:w-3/5">
                        ...
                        <div className="mt-10 mb-5">
                            <div className="mb-3">
                                ...
                                <input name="email" className="w-full p-1 bg-transparent border-b border-black rounded outline-none" placeholder="abc@gmail.com" />
                            </div>
                            <div className="mb-3">
                                <label className="block font-semibold text-left">Password</label>
                                <input name="password" type="password" className="w-full p-1 bg-transparent border-b border-black rounded outline-none" placeholder="*********" />
                            </div>
                        </div>
                        <button className="w-full p-2 font-semibold transition-all duration-300 bg-black rounded hover:bg-gradient-to-t  from-red-500 to-black to-80%">Login</button>
